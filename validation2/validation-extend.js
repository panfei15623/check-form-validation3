            ...
            $elements.each(function (index, element) {
                ...
                var validateFunc = function () {
                    ...
                    if ((validateObj.required || $(element).val()) && (
                        ...
                        $(element).parent().next().html("<img src='/warning.png'/><span class='ks-red' style='font-size: 12px;padding-left: 3px'>" +
                        (ajaxValidateResult ? $(element).attr("placeholder") : validateObj.ajax.errorMessage) +
                        "</span>");
                    } else {
                        $(element).removeClass("danger").addClass("success");
                        $(element).parent().next().html("<img src='/ok.png'/><span class='ks-green'style='font-size: 12px;padding-left: 3px'>成功</span>");
                        result = true;
                    }
